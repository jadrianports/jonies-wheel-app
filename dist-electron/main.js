...
function createWindow() {
  ...
  win.on("enter-full-screen", () => {
    win == null ? void 0 : win.webContents.send("fullscreen-changed", true);
  });
  win.on("leave-full-screen", () => {
    win == null ? void 0 : win.webContents.send("fullscreen-changed", false);
  });
}
...
ipcMain.handle("import-names-from-xlsx", async () => {
  ...
  try {
    ...
    for (let i = 0; i < headers.length; i++) {
      const header = (_a = headers[i]) == null ? void 0 : _a.toLowerCase();
